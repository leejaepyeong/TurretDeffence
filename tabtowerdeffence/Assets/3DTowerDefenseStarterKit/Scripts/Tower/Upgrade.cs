...
public class Upgrade : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sphereCol = transform.parent.Find("RangeTrigger").gameObject.GetComponent<SphereCollider>();
        sphereCol.radius = options[curLvl].radius;

        //get rangeIndicator gameObject
        rangeIndicator = transform.parent.Find("RangeIndicator");
    ...
    public void TowerChange()
    {
        ...
        newTowerBase.rangeInd.GetComponent<Renderer>().enabled = true;
