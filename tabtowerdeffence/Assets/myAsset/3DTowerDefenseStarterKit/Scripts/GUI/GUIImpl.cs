...
public class GUIImpl : MonoBehaviour
{
        ...
        switch (buildMode)
        {
            ...
            case BuildMode.Grid:
            {
                     ...
                     !gui.mobile && Input.GetMouseButtonUp(0)) && gui.CheckIfGridIsFree() && !SV.selection)
                {
                    ...
                    SV.gridSelection.GetComponent<Renderer>().enabled = true;
                }
    ...
    public void CreateTower(int index)
    {
        ...
        //new additional check for ignoring deselected checkboxes
    ...
    public void EnableSelfControl()
    {
        ...
        if(gui.towerBase.idleAnim)
            gui.towerBase.GetComponent<Animation>().Stop(gui.towerBase.idleAnim.name);
